...
function Rectangle(box_name,x,y) {        
...
function push() {
        ...
        box_name = boxname();
        console.log(y);
        var rectangle = new Rectangle(box_name,x,y);
...
let draw = function() {
    ...
    for (var shape of rectangles){
        ...
        ctx.fillText(shape.box_name,shape.x+5,shape.y+10)
    }
}
...
//function to input the name of the box
let boxname = function(){
    let name = prompt("Enter text.");
    return name;
}
